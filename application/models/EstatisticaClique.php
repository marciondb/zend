...
class Application_Model_EstatisticaClique extends Application_Model_Abstract
{
    ...
    public function deletar($id_estatistica_clique)
    {
        ...
        {
            ZendUtils::transmissorMsg('Erro ao deletar a Estatistica, favor contactar o administrador<br>'.$e->getMessage(),  ZendUtils::MENSAGEM_ERRO,  ZendUtils::MENSAGEM_SEM_TEMPO);
        }
    }
